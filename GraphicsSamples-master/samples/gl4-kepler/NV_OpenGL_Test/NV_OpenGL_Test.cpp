//----------------------------------------------------------------------------------
// File:        gl4-kepler\NV_OpenGL_Test/NV_OpenGL_Test.cpp
// SDK Version: v3.00 
// Email:       gameworks@nvidia.com
// Site:        http://developer.nvidia.com/
//----------------------------------------------------------------------------------
#include "NV_OpenGL_Test.h"
...
////////////////////////////////////////////////////////////////////////////////
//
//  Method: NV_OpenGL_Test::draw()
//
//    Performs the actual rendering
//
////////////////////////////////////////////////////////////////////////////////
void NV_OpenGL_Test::draw(void)
{
    ...
    m_transformUniformsData.Use_NV_OpenGL_Test_Uniforms = m_Use_NV_OpenGL_Test_Uniforms;
    ...
    if(m_Use_NV_OpenGL_Test_Uniforms == true)
    {
        // *** INTERESTING ***
...
void NV_OpenGL_Test::InitBindlessTextures()
{
...
////////////////////////////////////////////////////////////////////////////////
//
//  Method: NV_OpenGL_Test::updatePerMeshUniforms()
//
//    Computes per mesh uniforms based on t and sends the uniforms to the GPU
//
////////////////////////////////////////////////////////////////////////////////
void NV_OpenGL_Test::updatePerMeshUniforms(float t)
{
    ...
    if(m_usePerMeshUniforms == true)
    {
        ...
        for(int32_t i=0; i<SQRT_BUILDING_COUNT; i++)
        {
            for(int32_t j=0; j<SQRT_BUILDING_COUNT; j++, index++)
            {
                ...
                m_perMeshUniformsData[index].r = sin(10.0f * radius + 0.04f*t);
    ...
    { 
        ...
        m_perMeshUniformsData[0].r = sin(4*t);
        m_perMeshUniformsData[0].g = cos(30*t);
        m_perMeshUniformsData[0].b = 1.0f;
        m_perMeshUniformsData[0].a = 0.0f;
...
//
////////////////////////////////////////////////////////////////////////////////
void NV_OpenGL_Test::initRendering(void) {
    ...
    NvAssetLoaderAddSearchPath("gl4-kepler/NV_OpenGL_Test");
...
////////////////////////////////////////////////////////////////////////////////
//
//  Method: NV_OpenGL_Test::NV_OpenGL_Test()
//
//
////////////////////////////////////////////////////////////////////////////////
NV_OpenGL_Test::NV_OpenGL_Test()
: m_drawCallsPerSecondText(NULL)
, m_Use_NV_OpenGL_Test_Uniforms(true)
, m_updateUniformsEveryFrame(true)
, m_usePerMeshUniforms(true)
, m_useBindlessTextures(true)
, m_currentFrame(0)
, m_currentTime(0.0f)
, m_t(0.0f)
...
NV_OpenGL_Test::~NV_OpenGL_Test()
{
    LOGI("NV_OpenGL_Test: destroyed\n");
}


////////////////////////////////////////////////////////////////////////////////
//
//  Method: NV_OpenGL_Test::initUI()
//
//    Sets up the user interface
//
////////////////////////////////////////////////////////////////////////////////
void NV_OpenGL_Test::initUI() {
    ...
    if (mTweakBar) { // create our tweak ui
        ...
        mTweakBar->addValue("Draw calls per state", Mesh::m_drawCallsPerState, 1, 10);
    }
    ...
    if (mFPSText) {
        ...
        m_drawCallsPerSecondText = new NvUIValueText("draw calls/sec", NvUIFontFamily::SANS, mFPSText->GetFontSize(), NvUITextAlign::RIGHT,
...
////////////////////////////////////////////////////////////////////////////////
//
//  Method: NV_OpenGL_Test::reshape()
//
//    Called when the viewport dimensions are changed
//
////////////////////////////////////////////////////////////////////////////////
void NV_OpenGL_Test::reshape(int32_t width, int32_t height)
{
...
////////////////////////////////////////////////////////////////////////////////
//
//  Method: NV_OpenGL_Test::createBuilding()
//
//    Create a very simple building mesh
//
////////////////////////////////////////////////////////////////////////////////
void NV_OpenGL_Test::createBuilding(Mesh& mesh, nv::vec3f pos, nv::vec3f dim, nv::vec2f uv)
{
...
////////////////////////////////////////////////////////////////////////////////
//
//  Method: NV_OpenGL_Test::createGround()
//
//    Create a mesh for the ground
//
////////////////////////////////////////////////////////////////////////////////
void NV_OpenGL_Test::createGround(Mesh& mesh, nv::vec3f pos, nv::vec3f dim)
{
    std::vector<Vertex>         vertices;
    std::vector<uint16_t> indices;
    float                  r, g, b;
...
////////////////////////////////////////////////////////////////////////////////
//
//  Method: NV_OpenGL_Test::randomColor()
//
//    Generates a random color
//
////////////////////////////////////////////////////////////////////////////////
void NV_OpenGL_Test::randomColor(float &r, float &g, float &b)
{
    r = float(rand() % 255) / 255.0f;
    g = float(rand() % 255) / 255.0f;
    b = float(rand() % 255) / 25.0f;
}
...
//
////////////////////////////////////////////////////////////////////////////////
void NV_OpenGL_Test::configurationCallback(NvGLConfiguration& config)
{ 
    config.depthBits = 24; 
